...
/*global exports */
(function () {
    var classes, finder, fs, onComplete, outputCTags, parseDir, parseFile, parseText, pending, parser, stripComments, isIdentifier, getLastPart;
    fs = require('fs');
    ...
    parseText = function (fileStr) {
        ...
        parseLine = function (line) {
            ...
            if (cons_res) {
                params = [];
                //if has params...
                if (cons_res.length > 1) {
                    params = [];
                    params_str = cons_res[1];
                    //stripComments
